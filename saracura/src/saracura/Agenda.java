...
public class Agenda {
	...
	// Informa se o horario correpondente a DataHora informado est� livre para
	// agendamento e n�o gera conflitos
	...
	// Informa se agenda est� carregada com informa��es do BD
